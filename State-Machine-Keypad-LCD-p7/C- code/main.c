...
char keypad = 0x0000;
char testlatch = 0b10101010;
// Timer1 output compare A interrupt service routine
interrupt [TIM1_COMPA] void timer1_compa_isr(void)
{
				writeLatch(testlatch);
				testlatch=~testlatch;
...
unsigned int checkkeypad(void){
	...
	writeLatch(0b01111111); //check column 1
	data = readStatus();
	keypadvalue = ((unsigned int)(data & 0xF0));
	
	writeLatch(0b10111111); //check column 2
	data = readStatus();
	keypadvalue |= ((unsigned int)(data & 0xF0))<<4;
	
	writeLatch(0b11011111); //check column 3
	data = readStatus();
	keypadvalue |= ((unsigned int)(data & 0xF0))<<4;
	
	writeLatch(0b11101111);//check column 4
	data = readStatus();
	keypadvalue |= ((unsigned int)(data & 0xF0))>>4;
...
// Declare your local variables here
 int buttonPressed=0;
unsigned char str[] = "Lab 07";			// Declare the string to display Lab 07
//uint8_t i;							
...
// Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In 
DDRK=(0<<DDK7) | (0<<DDK6) | (0<<DDK5) | (1<<DDK4) | (1<<DDK3) | (1<<DDK2) | (1<<DDK1) | (1<<DDK0);
// State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T 
