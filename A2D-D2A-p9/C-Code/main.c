...
// Place your code here
	...
	/**Q13
	outputtoDA(0,valueSaw);
	outputtoDA(1,valueSaw);
	outputtoDA(2,valueSaw);
	outputtoDA(3,valueSaw);
	valueSaw++;
	**/
	
	//Question 16
	outputtoDA(0,(read_adc(0b100100)>>2));
...
ICR1H=0x00;
ICR1L=0x00;
OCR1AH=0x4E;	//100hz ah=4e al = 20 //1000Hz ah = 07 al=D0
OCR1AL=0x20;
OCR1BH=0x00;
OCR1BL=0x00;
OCR1CH=0x00;
